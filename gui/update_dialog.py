...
class UpdateDownloadDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.restart_btn = self.button_box.addButton("Close", QtWidgets.QDialogButtonBox.ButtonRole.AcceptRole)
        self.close_btn = self.button_box.addButton("Done", QtWidgets.QDialogButtonBox.ButtonRole.RejectRole)
    ...
    def show_complete(self):
        self.progress_bar.setValue(100)
        self.status_label.setText("Update downloaded! Please close and restart the application to apply it.")
        self.restart_btn.show()
        self.close_btn.show()
        self.progress_bar.setEnabled(False)

    def show_error(self, error_text: str):
        self.status_label.setText(f"<span style='color:#c00;'>Update failed:</span><br>{error_text}")
        self.progress_bar.setEnabled(False)
        self.restart_btn.hide()
        self.close_btn.show()
